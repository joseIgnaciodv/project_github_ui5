		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Github UI5",
									"targetURL": "#projectgithubui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectgithubui5-display": {
								"semanticObject": "projectgithubui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectgithubui5",
									"url": sap.ui.require.toUrl("projectgithubui5")
								}
							}
						}
					}
